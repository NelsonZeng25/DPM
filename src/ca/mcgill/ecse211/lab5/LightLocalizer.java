...
public class LightLocalizer {
  ...
  public static void localize() {
    ...
    // Theta correction code
    // Turn the robot to ~45 and turn anti-clockwise until a line is detected
    // The orientation of the robot should be approx 0 when the line hit
    Navigation.turnTo(45);
    while (Math.abs(getRedValue() - initialRedValue) < rgbThreshold) {
      leftMotor.backward();
      rightMotor.forward();
